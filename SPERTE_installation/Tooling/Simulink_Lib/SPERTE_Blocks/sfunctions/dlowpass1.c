...
/*
	discrete time 1st order lowpass filter (Matlab 6 version)
	...
	Parameter: [f_den] (frequency in Hz)
*/

#define S_FUNCTION_NAME dlowpass1
...
static void mdlInitializeSampleTimes(SimStruct *S)
{
	if (ssIsVariableStepSolver(S)) {
		...
		printf("dlowpass1: discete stepsize = %f s.\n",get_step_size(S));
#endif
	} else {
